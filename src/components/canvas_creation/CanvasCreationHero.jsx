...
const CanvasCreationHero = () => {
    return (
        <>
            <div className="w-full h-screen items-center px-[4vw]  flex  justify-between ">
                <div className=" h-[80%]   flex flex-col justify-center">
                    <div className=" h-[70%]  flex flex-col justify-end text-[10vw] capitalize leading-[8vw] font-thin">
                        <h2 className='  uppercase text-[#EB8529] text-sm font-semibold lg:text-xl'>An SDAF Art Camp</h2>
                        <h2>Canvas &</h2>
                ...
                <div className=" h-full flex justify-end items-center">
                    <div className="h-[80%] overflow-hidden w-[30vw]">
            ...
            <div className=" w-full my-44 flex flex-col items-center text-center">
                 <h2 className=" text-5xl w-1/2  leading-none">
                   What happens when you give artists exactly what they need?
                </h2>
                <p className="my-6 mt-10 w-1/2   text-sm lg:text-lg  opacity-80 ">
                ...
                <p className="mb-6  w-1/2  text-sm lg:text-lg  opacity-80 ">
                ...
                <p className="mb-6  uppercase text-sm lg:text-lg  opacity-80 ">
